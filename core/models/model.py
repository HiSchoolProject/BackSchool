...
class Model(models.Model):
    """Override Django model to add new functionnalities that ease model management in the HiSchool! project."""

    permission_class = None
    """The core.models.permission.ModelPermission related to the current model."""
