...
class APIDispatcher(Dispatcher):
    ...
    def generate_version_includes(self):
        """
        Create an iterable of urls where each url matches an API version and includes sub-urls extracted from
    ...
    def load_urls(self):
        """
        Using the class attributes, load API urls form the given applications and versions.
